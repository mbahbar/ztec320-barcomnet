...
curl -fsSL https://raw.githubusercontent.com/mbahbar/ztec320-barcomnet/main/install-vps.sh -o install-vps.sh
bash install-vps.sh
...
```bash
# Download and run (as root)
curl -fsSL https://raw.githubusercontent.com/mbahbar/ztec320-barcomnet/main/uninstall-vps.sh -o uninstall-vps.sh
