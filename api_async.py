...
# ---------------------------------------------------------------------------
fastapi_app = FastAPI(
    title="BARCOMNET NMS — Complete API Documentation",
    description="""**BARCOMNET NMS** — OLT Management System for FTTH networks.

## For External Developers

If you're building your own frontend or integrating with BARCOMNET NMS, use this API reference.
